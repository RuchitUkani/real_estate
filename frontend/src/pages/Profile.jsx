...
import { updateUserStart,updateUserSuccess,updateUserFailure,deleteUsetStart,deleteUserSuccess,deleteUserFailure,signOutUserStart,signOutUserSuccess,signOutUserFailure } from "../redux/user/userSlice.js";
    ...
    return(
        <div className="p-3 max-w-lg mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <img onClick={() => fileRef.current.click()} className="rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-0"
            ...
            <p className="text-green-700 mt-3">{updateSuccess ? "User Update Successfully!" : ""}</p>
